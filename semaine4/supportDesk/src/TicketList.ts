...
export class TicketList {
  ...
  private genererLigneTicket(ticket: Ticket): string {
  ...
  private getPrioriteClass(priorite: Priorite): string {
    switch (priorite) {
  ...
  private getPrioriteLabel(priorite: Priorite): string {
    switch (priorite) {
  ...
  private getStatutClass(statut: Statut): string {
    switch (statut) {
  ...
  private getStatutLabel(statut: Statut): string {
    switch (statut) {
  ...
  private genererInitiales(titre: string): string {
  ...
  private genererCouleurAvatar(id: string): string {
    const couleurs = [
